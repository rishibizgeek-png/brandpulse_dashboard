...
function Home() {
  ...
  useEffect(() => {
    ...
    if (mentionsRef.current) {
      const ctx = mentionsRef.current.getContext("2d");
      ...
      mentionsChartInstance = new Chart(ctx, {
        ...
        data: {
          ...
          datasets: [
            {
              label: "Mentions",
              data: [120, 150, 140, 170, 180, 200, 220], // demo data
              fill: true,
          ...
          datasets: [
            {
              ...
              data: [200, 320, 280, 400, 360, 420, 480], // demo data
      ...
      <section className="mt-8 grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-[#182b34] p-6 rounded-2xl shadow-lg">
          ...
          <div className="mt-4 h-64">
            <canvas ref={mentionsRef} className="w-full h-full"></canvas>
          </div>
        </div>
        ...
        <div className="bg-[#182b34] p-6 rounded-2xl shadow-lg">
          ...
          <div className="mt-4 h-64">
            <canvas ref={growthRef} className="w-full h-full"></canvas>
          </div>
        </div>
      </section>
    </main>
